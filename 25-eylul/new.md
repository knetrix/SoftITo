      ...
      <main class="layout">
        ...
        <section class="panel">
          ...
          <div id="orderContainer" class="order-list">
            <!--Dinamik Olarak Elemanlar Buraya
                    Basılacak / Eklenecek-->
          </div>
        </section>
      </main>
    ...
    <script>
      ...
      const renderOrders = () => {
        ...
        const filtered = orders.filter((order) => {
          ...
          return matchesName && mathesCategory;
        });
